...
h2_samp_var <- function(Ped, h2=0.3, plot=FALSE){
	...
	if(plot & length(h2)>1) plot(h2_samp_var~h2, xlab="Heritability",ylab="Expected Sampling Variance", main="Expected Sampling Variance of Heritability based on Visscher & Goddard 2016",type="b")
